...
root.title("Speed Breaker Detection System")
...
heading = tk.Label(root,text="Speed Breaker Detection System",width=100,height=2,font=("Times New Roman",21,"italic"),bg="black",fg="white")
...
#         "authorization":"yb1C2gPEhlD7RSLOU36uF8TIawprmXezZfQ40xNtnko5c9djBKwqu2NDKUGt9oZ53XSypM6BHP1xCfzF",
#         "sender_id":"SMSINI",
#         "message":msg,
#         "language":"english",
#         "route":"p",
...
def show_FDD_video(video_path):
    ...
    while True:
        ...
        if  label == 1 :
            label_text = "Speed Breaker Detected"
            color = red
            ...
            label_text = "Speed Breaker Not Detected"
            color = green
...
button5 = tk.Button(root,command = Video_Verify, text="Speed Breaker Detection", width=20,font=("Tempus Sanc ITC",15),bg="cyan",fg="black")
button5.place(x=100,y=100)


# button6 = tk.Button(root,command = train_model, text="Video Verification", width=20,font=("Tempus Sanc ITC",15),bg="cyan",fg="black")
