...
path1 = 'E:/New Projects Code/Speed Breaker Detection/Accident Detection/acident detection/acident detection/Accident_detection/Accident_detection/0'    #path of folder of images    
path2 = 'E:/New Projects Code/Speed Breaker Detection/Accident Detection/acident detection/acident detection/Accident_detection/Accident_detection/test_set/0'  #path of folder to save images    
